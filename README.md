...
| <img src="https://github.com/Si-Boni-apps.png" width="60" height="60" alt="Si Boni Logo"/> | Si Boni | • Developer & System Architect: Fully responsible for technical aspects, designing code architecture (MVVM via Provider), implementing all interactive game mechanics logic, integrating accessibility features (*Text-to-Speech*). |
